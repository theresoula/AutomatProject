...
public class AutomatProject {
    ...
    public static void main(String[] args) {
        ...
        Scanner scan = new Scanner(System.in); //av någon anledning 
        //behöver jag ha scanner här så inte loopen håller på i en evighet 
        //om något blir fel
        
        System.out.println("[1] Show all products");
        System.out.println("[2] Select Beverages");
        System.out.println("[3] Select Sweaters");
        System.out.println("[4] Exit Automat Shop");
        ...
        menu = scan.nextInt();
            ...
            switch (menu){
                ...
                System.out.println("Please enter a number between 1-4 to choose in the menu or 5 to exit"); 
                 ...
                 System.out.println("Please select in the meny by entering number 1 - 5");
        }
